 ...
 */
public class ScrollerListActivity extends Activity {
    private FullyListView rv;
    private ScrollView sl;

    @Override
    protected void onCreate(Bundle savedInstanceState) {
        super.onCreate(savedInstanceState);
        setContentView(R.layout.a_scorllerlist);
...
//		gridView1.setFocusable(false);//这个也 可以解决ScrollView起始位置不是最顶部的解决办法
        ...
        rv = (FullyListView) findViewById(R.id.gridView1);
